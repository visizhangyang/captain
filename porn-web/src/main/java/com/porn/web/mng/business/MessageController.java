...
public class MessageController
    ...
    public Msg<PageVo<MessageVo>> queryPage(@RequestBody MessageQueryPageDTO messageQueryPageDTO) {
        Objects.requireNonNull(this.messageApiService);
        return Msg.executeService(messageQueryPageDTO, this.messageApiService::queryPage);
    }
    ...
    public Msg<MessageVo> saveOrUpdate(@RequestBody MessageSaveOrUpdateDTO messageSaveOrUpdateDTO) {
        Objects.requireNonNull(this.messageApiService);
        return Msg.executeService(messageSaveOrUpdateDTO, this.messageApiService::saveOrUpdate);
    }
    ...
    public Msg<Boolean> batchDelete(@RequestBody MessageBatchDeleteDTO messageBatchDeleteDTO) {
        Objects.requireNonNull(this.messageApiService);
        return Msg.executeService(messageBatchDeleteDTO, this.messageApiService::batchDelete);
    }
    ...
    public Msg<List<String>> adminMsg(@RequestBody AdminMessageDTO adminMessageDTO) {
        Objects.requireNonNull(this.messageApiService);
        return Msg.executeService(adminMessageDTO, this.messageApiService::adminMsg);
    }
}
