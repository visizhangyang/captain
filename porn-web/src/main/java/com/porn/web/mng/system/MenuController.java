...
public class MenuController
    ...
    public Msg<List<MenuVo>> queryMenuList(@RequestBody MenuQueryDTO menuQueryDTO) {
        Objects.requireNonNull(this.menuApiService);
        return Msg.executeService(menuQueryDTO, this.menuApiService::queryMenuList);
    }
    ...
    public Msg<MenuVo> saveOrUpdate(@RequestBody MenuSaveOrUpdateDTO menuSaveOrUpdateDTO) {
        Objects.requireNonNull(this.menuApiService);
        return Msg.executeService(menuSaveOrUpdateDTO, this.menuApiService::saveOrUpdate);
    }
    ...
    public Msg<Boolean> delete(@RequestBody MenuDeleteDTO menuDeleteDTO) {
        Objects.requireNonNull(this.menuApiService);
        return Msg.executeService(menuDeleteDTO, this.menuApiService::delete);
    }
}
