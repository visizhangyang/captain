...
/* 36 */     Objects.requireNonNull(this.noticeApiService); return Msg.executeService(noticeQueryPageDTO, this.noticeApiService::queryPage);
/*    */   }
/*    */   
/*    */   @ApiOperation("新增或更新")
/*    */   @PostMapping({"/saveOrUpdate"})
/*    */   public Msg<NoticeVo> saveOrUpdate(@RequestBody NoticeSaveOrUpdateDTO noticeSaveOrUpdateDTO) {
/* 42 */     Objects.requireNonNull(this.noticeApiService); return Msg.executeService(noticeSaveOrUpdateDTO, this.noticeApiService::saveOrUpdate);
/*    */   }
/*    */   
/*    */   @ApiOperation("删除")
/*    */   @PostMapping({"/delete"})
/*    */   public Msg<Boolean> delete(@RequestBody NoticeDeleteDTO noticeDeleteDTO) {
/* 48 */     Objects.requireNonNull(this.noticeApiService); return Msg.executeService(noticeDeleteDTO, this.noticeApiService::delete);
/*    */   }
/*    */   
/*    */   @ApiOperation("更新创建时间")
...
/* 54 */     Objects.requireNonNull(this.noticeApiService); return Msg.executeService(noticeUpdateCreateTimeDTO, this.noticeApiService::updateCreateTime);
/*    */   }
/*    */ }


/* Location:              /Users/wh/Documents/个人资料/work/20250507/UPeak-3.3.0/lib/porn-web-3.3.0.jar!/com/porn/web/mng/business/NoticeController.class
