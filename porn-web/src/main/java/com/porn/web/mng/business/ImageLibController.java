...
public class ImageLibController
    ...
    public Msg<PageVo<ImageLibVo>> queryPage(@RequestBody ImageLibQueryPageDTO imageLibQueryPageDTO) {
        Objects.requireNonNull(this.imageLibApiService);
        return Msg.executeService(imageLibQueryPageDTO, this.imageLibApiService::queryPage);
    }
    ...
    public Msg<Boolean> batchCreate(@RequestBody List<ImageLibSaveOrUpdateDTO> imageLibSaveOrUpdateDTOList) {
        Objects.requireNonNull(this.imageLibApiService);
        return Msg.executeSimpleService(imageLibSaveOrUpdateDTOList, this.imageLibApiService::batchSaveImageLib);
    }
    ...
    public Msg<Boolean> batchDelete(@RequestBody ImageLibBatchDeleteDTO imageLibBatchDeleteDTO) {
        Objects.requireNonNull(this.imageLibApiService);
        return Msg.executeService(imageLibBatchDeleteDTO, this.imageLibApiService::batchDelete);
    }
}
