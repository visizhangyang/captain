...
public class PlanController
    ...
    public Msg<PageVo<PlanVo>> queryPage(@RequestBody PlanQueryPageDTO planQueryPageDTO) {
        Objects.requireNonNull(this.planApiService);
        return Msg.executeService(planQueryPageDTO, this.planApiService::queryPage);
    }
    ...
    public Msg<PlanVo> saveOrUpdate(@RequestBody PlanSaveOrUpdateDTO planSaveOrUpdateDTO) {
        Objects.requireNonNull(this.planApiService);
        return Msg.executeService(planSaveOrUpdateDTO, this.planApiService::saveOrUpdate);
    }
    ...
    public Msg<Boolean> delete(@RequestBody PlanDeleteDTO planDeleteDTO) {
        Objects.requireNonNull(this.planApiService);
        return Msg.executeService(planDeleteDTO, this.planApiService::delete);
    }
}
