...
/* 38 */     return Msg.success(Arrays.<DescTypeEnum>stream(DescTypeEnum.values()).map(dt -> Pair.of(dt.getDescription(), dt.getType())).collect(Collectors.toList()));
/*    */   }
/*    */   
/*    */   @ApiOperation("查询")
/*    */   @PostMapping({"/queryDescList"})
/*    */   public Msg<List<DescVo>> queryDescList(@RequestBody DescQueryDTO descQueryDTO) {
/* 44 */     Objects.requireNonNull(this.descApiService); return Msg.executeService(descQueryDTO, this.descApiService::queryDescList);
/*    */   }
/*    */   
/*    */   @ApiOperation("新增或更新")
/*    */   @PostMapping({"/batchCreate"})
/*    */   public Msg<Boolean> saveOrUpdate(@RequestBody List<DescSaveOrUpdateDTO> descSaveOrUpdateDTOList) {
/* 50 */     Objects.requireNonNull(this.descApiService); return Msg.executeSimpleService(descSaveOrUpdateDTOList, this.descApiService::batchCreate);
/*    */   }
/*    */ }


/* Location:              /Users/wh/Documents/个人资料/work/20250507/UPeak-3.3.0/lib/porn-web-3.3.0.jar!/com/porn/web/mng/business/DescController.class
