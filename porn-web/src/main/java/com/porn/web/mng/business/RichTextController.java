...
/* 38 */     return Msg.success(this.richTextApiService.queryTypes());
/*    */   }
/*    */   
/*    */   @ApiOperation("查询")
/*    */   @PostMapping({"/queryRichText"})
/*    */   public Msg<RichTextVo> queryRichText(@RequestBody RichTextQueryDTO richTextQueryDTO) {
/* 44 */     Objects.requireNonNull(this.richTextApiService); return Msg.executeService(richTextQueryDTO, this.richTextApiService::queryRichText);
/*    */   }
/*    */   
/*    */   @ApiOperation("新增或更新")
/*    */   @PostMapping({"/saveOrUpdate"})
/*    */   public Msg<RichTextVo> saveOrUpdate(@RequestBody RichTextSaveOrUpdateDTO richTextSaveOrUpdateDTO) {
/* 50 */     Objects.requireNonNull(this.richTextApiService); return Msg.executeService(richTextSaveOrUpdateDTO, this.richTextApiService::saveOrUpdate);
/*    */   }
/*    */ }


/* Location:              /Users/wh/Documents/个人资料/work/20250507/UPeak-3.3.0/lib/porn-web-3.3.0.jar!/com/porn/web/mng/business/RichTextController.class
