...
public class TransferController
    ...
    public Msg<PageVo<TransferVo>> queryPage(@RequestBody TransferQueryPageDTO transferQueryPageDTO) {
        Objects.requireNonNull(this.transferApiService);
        return Msg.executeService(transferQueryPageDTO, this.transferApiService::queryPage);
    }
    ...
    public Msg<Boolean> audit(@RequestBody TransferAuditDTO transferAuditDTO) {
        Objects.requireNonNull(this.transferApiService);
        return Msg.executeService(transferAuditDTO, this.transferApiService::audit);
    }
    ...
    public Msg<Boolean> reject(@RequestBody TransferRejectDTO transferRejectDTO) {
        Objects.requireNonNull(this.transferApiService);
        return Msg.executeService(transferRejectDTO, this.transferApiService::reject);
    }
    ...
    public Msg<Boolean> delete(@RequestBody TransferDeleteDTO transferDeleteDTO) {
        Objects.requireNonNull(this.transferApiService);
        return Msg.executeService(transferDeleteDTO, this.transferApiService::delete);
    }
}
