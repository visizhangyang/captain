...
public class InlineController
    ...
    public Msg<List<InlineVo>> queryWorkrobotList(@RequestBody InlineQueryDTO inlineQueryDTO) {
        Objects.requireNonNull(this.inlineApiService);
        return Msg.executeService(inlineQueryDTO, this.inlineApiService::queryInlineList);
    }
    ...
    public Msg<Boolean> saveOrUpdate(@RequestBody List<InlineSaveOrUpdateDTO> inlineSaveOrUpdateDTOList) {
        Objects.requireNonNull(this.inlineApiService);
        return Msg.executeSimpleService(inlineSaveOrUpdateDTOList, this.inlineApiService::batchCreate);
    }
}
