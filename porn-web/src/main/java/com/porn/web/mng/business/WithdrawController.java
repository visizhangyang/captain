...
/* 38 */     Objects.requireNonNull(this.withdrawApiService); return Msg.executeService(withdrawQueryPageDTO, this.withdrawApiService::queryPage);
/*    */   }
/*    */   
/*    */   @ApiOperation("分页查询")
/*    */   @PostMapping({"/pass"})
/*    */   public Msg<WithdrawVo> pass(@RequestBody WithdrawPassDTO withdrawPassDTO) {
/* 44 */     Objects.requireNonNull(this.withdrawApiService); return Msg.executeService(withdrawPassDTO, this.withdrawApiService::pass);
/*    */   }
/*    */   
/*    */   @ApiOperation("退回")
/*    */   @PostMapping({"/cancel"})
/*    */   public Msg<Boolean> cancel(@RequestBody WithdrawCancelDTO withdrawCancelDTO) {
/* 50 */     Objects.requireNonNull(this.withdrawApiService); return Msg.executeService(withdrawCancelDTO, this.withdrawApiService::cancel);
/*    */   }
/*    */   
/*    */   @ApiOperation("删除")
/*    */   @PostMapping({"/delete"})
/*    */   public Msg<Boolean> delete(@RequestBody WithdrawDeleteDTO withdrawDeleteDTO) {
/* 56 */     Objects.requireNonNull(this.withdrawApiService); return Msg.executeService(withdrawDeleteDTO, this.withdrawApiService::delete);
/*    */   }
/*    */ }


/* Location:              /Users/wh/Documents/个人资料/work/20250507/UPeak-3.3.0/lib/porn-web-3.3.0.jar!/com/porn/web/mng/business/WithdrawController.class
