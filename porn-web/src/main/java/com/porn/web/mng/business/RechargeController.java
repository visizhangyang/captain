...
public class RechargeController
    ...
    public Msg<PageVo<RechargeVo>> queryPage(@RequestBody RechargeQueryPageDTO rechargeQueryPageDTO) {
        ...
        return Msg.executeService(rechargeQueryPageDTO, this.rechargeApiService::queryPage);
    }
    ...
    public Msg<Boolean> receipt(@RequestBody RechargeReceiptDTO rechargeReceiptDTO) {
        Objects.requireNonNull(this.rechargeApiService);
        return Msg.executeService(rechargeReceiptDTO, this.rechargeApiService::receipt);
    }
    ...
    public Msg<Boolean> cancel(@RequestBody RechargeCancelDTO rechargeCancelDTO) {
        Objects.requireNonNull(this.rechargeApiService);
        return Msg.executeService(rechargeCancelDTO, this.rechargeApiService::cancel);
    }
    ...
    public Msg<Boolean> delete(@RequestBody RechargeDeleteDTO rechargeDeleteDTO) {
        Objects.requireNonNull(this.rechargeApiService);
        return Msg.executeService(rechargeDeleteDTO, this.rechargeApiService::delete);
    }
}
